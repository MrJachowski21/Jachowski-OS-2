...
namespace JachowskiOS2.Graphics
{
    public static class GUI
    {
        ...
        public static void StartGUI()
        {
            ...
            ProcessManager.Start(new Messagebox { WindowData = new WindowData { WinPos = new Rectangle(100, 450, 350, 200) }, Name = "JachowskiOS" });
        }
    }
}
